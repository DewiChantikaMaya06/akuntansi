...
<head>
  ...
  <!-- Favicon -->
  <link href="<?= base_url('assets/argon/img/fav.png') ?>" rel="icon" type="image/png">
  <!-- Fonts -->
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-light" id="sidenav-main">
  <div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="./index.html">
      <img src="<?= base_url('assets/argon/img/fav.png') ?>" class="navbar-brand-img" alt="...">
    </a>
    <!-- User -->
      ...
      <div class="navbar-collapse-header d-md-none">
        <div class="row">
          <div class="col-6 collapse-brand">
            <a href="./index.html">
              <img src="<?= base_url('assets/argon/img/log.png') ?>">
            </a>
          </div>
