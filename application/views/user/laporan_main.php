            ...
            <div class="row">
              <div class="col my-3">
                <form action="<?= base_url('laporan/cetak') ?>" method="post" class="d-flex flex-row justify-content-center">
                  ...
                  <div class="form-group">
                    <button class="btn waves-effect waves-light btn-rounded btn-success" type="submit">Cetak</button>
                  </div>
                </form>
              </div>
            </div>
                  ...
                  ?>
                    <tr>
                      ...
                      <td scope="col">
                        ...
                        <?= form_button(['type' => 'submit', 'content' => 'Cetak Laporan', 'class' => 'btn waves-effect waves-light btn-rounded btn-success']) ?>
                        <?= form_close() ?>
                      </td>
                    </tr>
                  <?php
